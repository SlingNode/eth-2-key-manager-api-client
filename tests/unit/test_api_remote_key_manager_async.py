...
@pytest.mark.asyncio
async def test_list_remote_keys_200(httpx_mock: HTTPXMock):
    ...
    response = await client.list_remote_keys.asyncio()
...
async def test_list_remote_keys_errors(status_code: int, mock_response: Dict, httpx_mock: HTTPXMock):
...
@pytest.mark.asyncio
async def test_import_remote_keys_200(httpx_mock: HTTPXMock):
    ...
    response = await client.import_remote_keys.asyncio(remote_keys=remote_keys)
...
@pytest.mark.asyncio
@pytest.mark.parametrize("status_code, mock_response", test_data_error_responses)
async def test_import_remote_keys_errors(status_code: int, mock_response: Dict, httpx_mock: HTTPXMock):
...
@pytest.mark.asyncio
async def test_delete_remote_keys_200(httpx_mock: HTTPXMock):
    ...
    response = await client.delete_remote_keys.asyncio(pubkeys=pub_keys)
...
@pytest.mark.asyncio
@pytest.mark.parametrize("status_code, mock_response", test_data_error_responses)
async def test_delete_remote_keys_errors(status_code: int, mock_response: Dict, httpx_mock: HTTPXMock):
