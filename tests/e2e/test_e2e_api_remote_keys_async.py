...
async def test_e2e_api_remote_keys_docstrings_code(set_valid_client_config_env_vars):

    if set_valid_client_config_env_vars == "PRYSM":
        pytest.skip("Skipping this test for Prysm - remote keys require different wallet type.")
