...
async def test_e2e_api_local_key_manager_docstrings_code(set_valid_client_config_env_vars):
    ...
    response = await eth_2_key_manager.import_keystores.asyncio_detailed([keystore_str], [keystore_password_str], slashing_protection_str)
