...
This module contains the Client and AuthenticatedClient classes.
Eth 2 Key Manager API specification dictates that all sensitive endpoints must be authenticated. All
endpoints do require authentication so the AuthenticatedClient is the class you interact with.
The Client class is never accessed directly.
